...
public class KeyBoardInput implements KeyListener {
    ...
    public void EscreverArquivo() throws IOException {
        ...
        int i = 0;
        String x, y, z,vertice, transformacao = null, etapa, parametro1, parametro2;
        ...
        bufferW.newLine();
        bufferW.write("# Pontos de controle para uma curva de grau " + (Main.tamanho-1));
        bufferW.newLine();
        bufferW.write("#--------------------------------------------------------------------------");
        bufferW.newLine();
        ...
        if (e.getKeyCode() == KeyEvent.VK_SPACE) { // COMEÇA AS TRANSFORMAÇÕES 
            ...
            if (percorrerTrans < qtdTransformacoes) {
                ...
                if(transformacoes[percorrerTrans][0] == 1){ // TRANSLAÇÃO TEXTO
                    ...
                    poly = "Transformcação de Rotação de " + transformacoes[percorrerTrans][1] + " graus no eixo x " + transformacoes[percorrerTrans][2] + " , graus no eixo y " + transformacoes[percorrerTrans][3] + " e no eixo z " ;
                }
                percorrerTrans++;
