    ...
    public void display(GLAutoDrawable drawable) {
        ...
        if (Main.leuArquivo) { // JA TENHO O MEU VETOR DE PONTO PREENCHIDOS POIS PREECHI LENDO O ARQUIVO
            ...
            if (tenhoDesenho == false) {
                ...
                surperficieAntes.setRed(255);
                surperficieAntes.setGreen(105);
                surperficieAntes.setBlue(180);
            }
        ...
        if (KeyBoardInput.transformei && tenhoDesenho == true) { // TENHO TRANSFORMAÇÕES LOGO, TENHO QUE MOSTRAR 2 SUPERFICIES UMA ANTES E A OUTRA DEPOIS
            ...
            if (percorrerTrans - 1 >= 1) { // SEGUNDA TRANSFORMAÇÃO
                ...
                glut.glutBitmapString(5, "Antes da Transformação " + percorrerTrans); //PLOTAR O DESENHO ONDE 5 É A FONTE E "Antes da transformação é o texto" 
